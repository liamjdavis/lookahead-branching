...
const unsigned GlobalConfiguration::NUM_LOOKAHEAD_BRANCHES = 20;
const unsigned GlobalConfiguration::NUM_LOOKAHEAD_CANDIDATES = 10;
const unsigned GlobalConfiguration::LOOKAHEAD_MAX_STACK_DEPTH = 5;
